...
import { Plane, MapPin, Calendar, Search, Clock } from 'lucide-react';
...
const HomePage: React.FC = () => {
  ...
  const handleSearch = (e: React.FormEvent) => {
    ...
    const qs = new URLSearchParams({ from, to, date, time }).toString();
    navigate(`/flights?${qs}`);
  };
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div
        ...
        style={{
          backgroundImage:
            'url(https://images.pexels.com/photos/912050/pexels-photo-912050.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2)',
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                  <div className="relative">
                    ...
                    <input
                      type="text"
                      placeholder="From"
                      className="w-full pl-10 pr-4 py-3 border rounded-md focus:outline-none focus:ring-2 focus:ring-[#d0e7d2]"
                      value={from}
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12 text-[#043927]">
            Why Choose Skyward
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-md text-center hover:shadow-lg transition-shadow duration-300">
              ...
              <h3 className="text-xl font-semibold mb-2 text-[#043927]">
                Best Prices
              </h3>
              <p className="text-gray-600">
                Competitive prices for all destinations, with special discounts
                for early bookings.
              </p>
            </div>
            <div className="bg-white p-8 rounded-lg shadow-md text-center hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-gray-600">
                Simple, fast, and secure booking process that saves you time
                and hassle.
              </p>
            </div>
            <div className="bg-white p-8 rounded-lg shadow-md text-center hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-gray-600">
                Change your travel dates with minimal fees, giving you peace
                of mind.
              </p>
            </div>
          </div>
      ...
      >
        <div className="absolute inset-0 bg-[#043927] bg-opacity-80" />
        <div className="container mx-auto px-4 relative z-10 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Ready to explore the world?
          </h2>
          <p className="text-xl text-white mb-8 max-w-2xl mx-auto">
            Book your flight today and experience the comfort and reliability of
            Skyward Airlines.
          </p>
